...
<body>
    <div class='email-container'>
        ...
        <div class='content'>
            ...
            <p>Olá, <b>{nome}</b>!</p>
            <p>Recebemos um pedido para redefinir a palavra-passe associada à tua conta na plataforma <b>CloudInvoice</b>.</p>
            <p>Se fizeste este pedido, clica no botão abaixo para definir uma nova palavra-passe:</p>

            <div class='btn-container'>
                <a href='{linkParaReset}' class='btn'>Redefinir Palavra-passe</a>
            </div>

            <p style='font-size: 14px; color: #6c757d;'>
                Se o botão não funcionar, copia e cole este link no teu navegador:<br>
                <a href='{linkParaReset}' style='color: #727cf5; word-break: break-all;'>{linkParaReset}</a>
            </p>

            <p style='font-size: 13px; color: #adb5bd; margin-top: 30px;'>
                Se não solicitaste esta alteração, podes ignorar este e-mail com segurança. A tua palavra-passe atual manter-se-á inalterada.
            </p>
        </div>
